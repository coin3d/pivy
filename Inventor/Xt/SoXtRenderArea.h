...
// src/Inventor/Xt/SoXtRenderArea.h.  Generated from SoGuiRenderArea.h.in by configure.
...
%{
static SbBool
SoXtRenderAreaEventPythonCB(void * closure, XAnyEvent * event)
{
  PyObject *func, *arglist;
  PyObject *result, *gdkev;
  int ires = 0;

  gdkev = SWIG_NewPointerObj((void *) event, SWIGTYPE_p_XAnyEvent, 1);
  ...
  if ((result = PyEval_CallObject(func, arglist)) == NULL) {
	printf("SoXtRenderAreaEventPythonCB(void * closure, XAnyEvent * event) failed!\n");
  }
  else {
...
public:
  ...
  %extend {
	void setPythonEventCallback(PyObject *pyfunc, PyObject *user = NULL) {
	  ...
	  self->setEventCallback(SoXtRenderAreaEventPythonCB, (void *) t);
	}
  }
#endif
